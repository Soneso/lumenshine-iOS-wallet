...
class RemoveCurrencyViewController: UIViewController {
    ...
    @IBAction func removeButtonAction(_ sender: UIButton) {
        ...
        if self.wallet.nativeBalance.availableAmount.isLess(than: CoinUnit.Constants.transactionFee + CoinUnit.Constants.baseReserver) {
    ...
    private func setupNavigationItem() {
        ...
        titleView.label.text = "Remove currency"
